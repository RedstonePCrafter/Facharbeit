...
public class SynchronizationRequest extends StringRequest {
    ...
    public SynchronizationRequest(String email, String password, String gewicht, String groesse, String geschlecht,String json,Response.Listener<String> listener) {
